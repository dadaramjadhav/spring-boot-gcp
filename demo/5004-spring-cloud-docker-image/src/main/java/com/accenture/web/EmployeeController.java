...
public class EmployeeController {
	...
	public ResponseEntity<String> welcome() throws UnknownHostException {
		...
		return new ResponseEntity<String>("Welcome to docker image creation using artifact registry in GCP running on port: "+ port + "  hostname is : "+ hostName + "  hostaddress : " + hostAddress, HttpStatus.OK);
	}
