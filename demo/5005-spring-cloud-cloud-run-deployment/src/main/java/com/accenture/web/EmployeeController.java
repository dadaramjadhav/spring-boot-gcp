...
public class EmployeeController {
	...
	public ResponseEntity<String> welcome() throws UnknownHostException {
		...
		return new ResponseEntity<String>("Welcome to Cloud run deployment using GCP running on port: "+ port + "  hostname is : "+ hostName + "  hostaddress : " + hostAddress, HttpStatus.OK);
	}
