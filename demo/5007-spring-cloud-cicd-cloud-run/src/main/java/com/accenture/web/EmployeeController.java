...
public class EmployeeController {
	...
	public ResponseEntity<String> welcome() throws UnknownHostException {
		...
		return new ResponseEntity<String>("Welcome to cloud run deployment using CICD with GCP  port: "+ port + "  hostname is : "+ hostName + "  hostaddress : " + hostAddress, HttpStatus.OK);
	}
